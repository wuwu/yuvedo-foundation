<form role="search" method="get" class="search-form flex items-center max-w-sm mx-auto" action="{{ home_url('/') }}">
  ...
  <input
    ...
    name="s"
    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:border-gray-600 placeholder-gray-400 dark:text-black"
  />
  <button class="bg-primary text-white p-2 rounded-md">
